...
const  Info = () => {
  return (
    ...
    <p className='mt-10 text-5xl font-semibold leading-tight tracking-wide mb-2.5 text-white'>BHASKAR</p>
    <p className='text-white mb-10 text-base leading-normal'>Frontend Developer</p>
