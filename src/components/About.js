  ...
  return (
    <ContainerWidth >
      <div className='py-16'>
        ...
        <p className='text-base font-normal leading-7 mb-7'>My name is <b>BHASKAR</b>, I have compIeted my bachelor's in computer science from Gurukul Kangri University in india and I'm passionate Frontend | UI Developer and I have experience on that, I developed web applications and UI of websites and I am always eager to explore new computer science Technology and also active  to learn <b>MERN</b> Stack.</p>
